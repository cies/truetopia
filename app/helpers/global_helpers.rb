module Merb
  module GlobalHelpers
    ...
    def debug_info
      [
        {:name => 'merb_config', :code => 'Merb::Config.to_hash', :string => Merb::Config.to_hash.inspect.to_s},
        {:name => 'params', :code => 'params.to_hash', :string => params.to_hash.inspect.to_s},
        {:name => 'session', :code => 'session.to_hash', :string => session.to_hash.inspect.to_s},
        {:name => 'cookies', :code => 'cookies', :string => cookies.inspect.to_s},
        {:name => 'request', :code => 'request', :string => request.inspect.to_s},
      ]
    end
  end
end
